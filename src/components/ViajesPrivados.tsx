  ...
  return (
    <section id="viajes-privados" className="pt-20 md:pt-28 pb-20 md:pb-28 relative z-10">
      <div className="max-w-[1200px] mx-auto px-5 md:px-10">
        ...
        <div
          className="border border-[rgba(200, 161, 90,0.35)] p-8 md:p-16 relative overflow-hidden"
          style={{ background: 'rgba(200, 161, 90,0.08)' }}
        >
          {/* Glow */}
          <div
