    ...
    <nav aria-label="Paginación" className="flex justify-center items-center gap-2 mt-16">
      {currentPage > 1 && (
        <Link
          ...
          className="inline-flex items-center justify-center w-10 h-10 border border-[rgba(212,168,83,0.2)] text-[var(--color-secondary)] no-underline text-sm transition-all duration-300 hover:border-[var(--color-accent)] hover:text-[var(--color-accent)]"
