  ...
  return (
    <div>
        ...
        {countries.map((c, i) => (
          <button
            ...
            style={{
              ...
              borderColor: selected === i ? 'var(--color-accent)' : 'rgba(212,168,83,0.15)',
            }}
          >
            {c.label}
          </button>
      ...
      <div
        ...
        style={{ background: 'rgba(212,168,83,0.04)', border: '1px solid rgba(212,168,83,0.1)' }}
      >
        ...
        {country.offsets.length > 1 && (
          <div className="mt-4 pt-3 text-center" style={{ borderTop: '1px solid rgba(212,168,83,0.1)' }}>
