    ...
    <>
      ...
      <section className="min-h-screen flex items-center justify-center px-5 py-20">
        ...
        >
          ...
          <a
            href="/"
            className="inline-block border border-[var(--color-accent)] bg-transparent text-[var(--color-accent)] px-8 py-4 text-sm uppercase tracking-[0.1em] font-bold no-underline transition-all duration-300 hover:bg-[var(--color-accent)] hover:text-[var(--color-bg)] hover:shadow-[0_0_20px_rgba(200,161,90,0.4)] relative z-10 mt-6"
          >
            VOLVER AL INICIO
          </a>
        </div>
