    ...
    <main className="min-h-screen py-20 px-5 md:px-10">
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-8 text-[0.9rem] leading-relaxed text-[var(--color-secondary)]">
          <section>
            <h2 className="text-lg font-semibold text-[var(--color-primary)] mb-3">1. Titular del Sitio</h2>
            <p>Asia Lo Posible es una marca operada por <a href="https://pondhorizons.xyz/" target="_blank" rel="noopener noreferrer" className="text-[var(--color-accent)] underline hover:no-underline">Pond Horizons LLC</a>, sociedad titular del sitio web asialoposible.net y responsable de los servicios aqu&iacute; ofrecidos.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-[var(--color-primary)] mb-3">2. Responsabilidad sobre Visas</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--color-primary)] mb-3">3. Costo Estimado de Visas</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--color-primary)] mb-3">4. Actualización de Requisitos</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--color-primary)] mb-3">5. Pasaporte</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--color-primary)] mb-3">6. Seguro de Viaje Obligatorio</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--color-primary)] mb-3">7. Limitación de Responsabilidad</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--color-primary)] mb-3">8. Contacto</h2>
            <p>Para consultas sobre este aviso legal, escríbenos a <a href="mailto:katherine@emails.asialoposible.net" className="text-[var(--color-accent)] underline hover:no-underline">katherine@emails.asialoposible.net</a>, por WhatsApp al +58 424 845 5010 o por Instagram a @kathmolinares.</p>
          </section>
        </div>
      </div>
    </main>
