  ...
  return (
    <>
        ...
        <div className="max-w-[1200px] mx-auto px-5 md:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {trustCards.map((card) => (
              <div
                key={card.title}
                className="border border-[rgba(212,168,83,0.15)] p-8 relative overflow-hidden animate-initial:opacity-0 animate-initial:y-20 animate-inview:opacity-100 animate-inview:y-0 animate-duration-600 animate-ease-out animate-once"
      ...
      <section className="pt-16 md:pt-20 pb-20 md:pb-28 relative z-10">
        <div className="max-w-[1200px] mx-auto px-5 md:px-10">
          <div
            className="border border-[rgba(212,168,83,0.2)] p-8 md:p-16 relative overflow-hidden animate-initial:opacity-0 animate-initial:scale-95 animate-inview:opacity-100 animate-inview:scale-100 animate-duration-700 animate-ease-out animate-once"
