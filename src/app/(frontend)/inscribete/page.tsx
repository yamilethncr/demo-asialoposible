...
export const metadata: Metadata = {
  ...
  description: 'Viaje organizado a Vietnam y Camboya en español. 14 días, 6 destinos, grupo exclusivo. Déjanos tus datos y te contactamos con el itinerario completo.',
  robots: { index: false, follow: true },
  alternates: { canonical: 'https://asialoposible.net/' },
}
